...
export const HOME_NAV: ModuleNavConfig = {
  ...
  items: [
    ...
    { type: 'item', name: 'Exams', href: '/exams', icon: ClipboardCheck, roles: ['admin', 'principal', 'teacher'] },
    { type: 'item', name: 'LMS', href: '/lms', icon: GraduationCap, roles: ['admin', 'principal', 'teacher'] },
    { type: 'item', name: 'Library', href: '/library', icon: BookOpen, roles: ['admin', 'principal', 'teacher', 'librarian'] },
    { type: 'item', name: 'Operations', href: '/operations', icon: Wrench, roles: ['admin', 'principal'] },
    { type: 'item', name: 'Management', href: '/management', icon: Building2, roles: ['admin', 'principal'] },
    { type: 'item', name: 'Timetable', href: '/calendar', icon: CalendarClock, roles: ['admin', 'principal', 'teacher'] },
    ...
    { type: 'item', name: 'Parent Portal', href: '/parent-portal', icon: MessageCircle, roles: ['parent'] },
