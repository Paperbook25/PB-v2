...
import type { BehaviorTabProps, BehaviorSubTab } from '../types/people.types'
              ...
              <CardContent className="pt-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Detentions</p>
                  </div>
              ...
              <ResponsiveContainer width="100%" height={250}>
                <PieChart>
                  <Pie
                    ...
                    dataKey="count"
                  >
                    {stats?.incidentsBySeverity.map((_, index) => (
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Button
              variant="ghost"
              size="sm"
              onClick={() => navigate('/people?tab=behavior&subtab=incidents')}
            >
              View All
...
// ============================================
// Detentions SubTab Component
// ============================================
function DetentionsSubTab() {
  const navigate = useNavigate()
  const { toast } = useToast()
  const [search, setSearch] = useState('')
