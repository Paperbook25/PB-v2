...
export function SocialFeedGrid({ section, theme }: VariantProps) {
  ...
  return (
    <section className={spacingClass(theme.sectionSpacing)}>
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className={`grid gap-6 ${platforms.length <= 2 ? 'grid-cols-1 sm:grid-cols-2 max-w-2xl mx-auto' : 'grid-cols-1 sm:grid-cols-2 lg:grid-cols-4'}`}>
          {platforms.map((platform) => (
            <a
              ...
              className={`${cardClass(theme.cardStyle, theme.cornerRadius)} p-6 flex flex-col items-center text-center gap-4 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 group`}
            >
              <div
