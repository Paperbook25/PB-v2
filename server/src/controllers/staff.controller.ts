...
export async function createStaff(req: Request, res: Response, next: NextFunction) {
  try {
    const staff = await staffService.createStaff(req.body as CreateStaffInput)
...
export async function updateStaff(req: Request, res: Response, next: NextFunction) {
  try {
    const staff = await staffService.updateStaff(String(req.params.id), req.body as UpdateStaffInput)
    res.json({ data: staff })
  } catch (err) {
    next(err)
  }
...
export async function deleteStaff(req: Request, res: Response, next: NextFunction) {
  try {
    const result = await staffService.deleteStaff(String(req.params.id))
    res.json(result)
  } catch (err) {
    next(err)
  }
...
export async function listAllPD(_req: Request, res: Response, next: NextFunction) {
  try {
    const records = await staffService.listAllPD()
...
export async function listStaffPD(req: Request, res: Response, next: NextFunction) {
  try {
    const records = await staffService.listStaffPD(String(req.params.id))
    res.json({ data: records })
  } catch (err) {
    next(err)
  }
...
export async function createPD(req: Request, res: Response, next: NextFunction) {
  try {
    const record = await staffService.createPD(String(req.params.id), req.body as CreatePDInput)
...
export async function updatePD(req: Request, res: Response, next: NextFunction) {
  try {
    const record = await staffService.updatePD(String(req.params.id), req.body as UpdatePDInput)
...
export async function deletePD(req: Request, res: Response, next: NextFunction) {
  try {
    const result = await staffService.deletePD(String(req.params.id))
    res.json(result)
  } catch (err) {
    next(err)
  }
...
export async function listAllReviews(_req: Request, res: Response, next: NextFunction) {
  try {
    const reviews = await staffService.listAllReviews()
...
export async function listStaffReviews(req: Request, res: Response, next: NextFunction) {
  try {
    const reviews = await staffService.listStaffReviews(String(req.params.id))
    res.json({ data: reviews })
  } catch (err) {
    next(err)
  }
...
export async function createReview(req: Request, res: Response, next: NextFunction) {
  try {
    const review = await staffService.createReview(req.body as CreateReviewInput)
...
export async function acknowledgeReview(req: Request, res: Response, next: NextFunction) {
  try {
    const review = await staffService.acknowledgeReview(String(req.params.id))
...
export async function listStaffSkills(req: Request, res: Response, next: NextFunction) {
  try {
    const skills = await staffService.listStaffSkills(String(req.params.id))
...
export async function addStaffSkill(req: Request, res: Response, next: NextFunction) {
  try {
    const skill = await staffService.addStaffSkill(String(req.params.id), req.body as CreateStaffSkillInput)
...
export async function deleteStaffSkill(req: Request, res: Response, next: NextFunction) {
  try {
    const result = await staffService.deleteStaffSkill(String(req.params.id), String(req.params.skillId))
    res.json(result)
  } catch (err) {
    next(err)
  }
...
export async function getSkillGaps(req: Request, res: Response, next: NextFunction) {
  try {
    const gaps = await staffService.getSkillGaps(String(req.params.id))
    res.json({ data: gaps })
  } catch (err) {
    next(err)
  }
...
export async function getSkillsMatrix(_req: Request, res: Response, next: NextFunction) {
  try {
    const matrix = await staffService.getSkillsMatrix()
...
export async function listStaffCertifications(req: Request, res: Response, next: NextFunction) {
  try {
    const certs = await staffService.listStaffCertifications(String(req.params.id))
    res.json({ data: certs })
  } catch (err) {
    next(err)
  }
...
export async function addCertification(req: Request, res: Response, next: NextFunction) {
  try {
    const cert = await staffService.addCertification(String(req.params.id), req.body as CreateCertificationInput)
...
export async function deleteCertification(req: Request, res: Response, next: NextFunction) {
  try {
    const result = await staffService.deleteCertification(String(req.params.id), String(req.params.certId))
    res.json(result)
  } catch (err) {
    next(err)
  }
...
export async function getExpiryAlerts(_req: Request, res: Response, next: NextFunction) {
  try {
    const alerts = await staffService.getExpiryAlerts()
...
export async function listOnboardingTasks(_req: Request, res: Response, next: NextFunction) {
  try {
    const tasks = await staffService.listOnboardingTasks()
    res.json({ data: tasks })
  } catch (err) {
    next(err)
  }
...
export async function listOnboardingChecklists(_req: Request, res: Response, next: NextFunction) {
  try {
    const checklists = await staffService.listOnboardingChecklists()
...
export async function getStaffOnboarding(req: Request, res: Response, next: NextFunction) {
  try {
    const checklist = await staffService.getStaffOnboarding(String(req.params.id))
...
export async function createOnboarding(req: Request, res: Response, next: NextFunction) {
  try {
    const checklist = await staffService.createOnboarding(String(req.params.id), req.body as CreateOnboardingInput)
...
export async function listExitInterviews(_req: Request, res: Response, next: NextFunction) {
  try {
    const interviews = await staffService.listExitInterviews()
...
export async function getExitInterview(req: Request, res: Response, next: NextFunction) {
  try {
    const interview = await staffService.getExitInterview(String(req.params.id))
...
export async function createExitInterview(req: Request, res: Response, next: NextFunction) {
  try {
    const interview = await staffService.createExitInterview(String(req.params.id), req.body as CreateExitInterviewInput)
...
export async function updateExitInterview(req: Request, res: Response, next: NextFunction) {
  try {
    const interview = await staffService.updateExitInterview(String(req.params.id), req.body as UpdateExitInterviewInput)
    res.json({ data: interview })
  } catch (err) {
    next(err)
  }
...
export async function bulkImport(req: Request, res: Response, next: NextFunction) {
  try {
    const results = await staffService.bulkImportStaff(req.body as BulkImportStaffInput)
...
export async function exportStaff(req: Request, res: Response, next: NextFunction) {
  try {
    const staff = await staffService.exportStaff()
    res.json({ data: staff })
  } catch (err) {
    next(err)
  }
